...
const Filters = ({ setStatus, setPageNumber, setGender, setSpecies, setSearch }) => {
  let clear = ()=> {
    setStatus("");
    setPageNumber("");
    setGender("");
  ...
  return (
    <div>
      <div className={`${styles.container} container fixed-left`}>
        ...
        <div className={`${styles.clearfilter} text-center text-decoration-underline mb-3`} onClick={clear}> Clear Filters </div>
